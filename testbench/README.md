...
SuppressionStage (off | conservative | Wiener spectral) → PeakLimiter`,
...
it (no DSP in Python). Wiener spectral is in the M7 pipeline; see `docs/spectral_postfilter.md`.
